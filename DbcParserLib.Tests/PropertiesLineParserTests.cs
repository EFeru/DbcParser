...
namespace DbcParserLib.Tests
{
    public class PropertiesLineParserTests
    {
        ...
        private SilentFailureObserver m_observer = new SilentFailureObserver();
        ...
        {
            var builder = new DbcBuilder(m_observer);

            var customPropertyLineParsers = CreateParser();
            var nextLineProvider = new NextLineProvider(new StringReader(string.Empty), m_observer);
