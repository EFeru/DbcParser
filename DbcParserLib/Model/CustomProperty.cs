...
{
    public CustomPropertyDefinition CustomPropertyDefinition { get; }
    public CustomPropertyValue<int> IntegerCustomProperty { get; private set; }
    public CustomPropertyValue<int> HexCustomProperty { get; private set; }
    public CustomPropertyValue<double> FloatCustomProperty { get; private set; }
    public CustomPropertyValue<string> StringCustomProperty { get; internal set; }
    public CustomPropertyValue<string> EnumCustomProperty { get; internal set; }
